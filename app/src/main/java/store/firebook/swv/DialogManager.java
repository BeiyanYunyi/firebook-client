...
import static store.firebook.swv.IntentHelper.createIntentForAmazonAppstore;
import static store.firebook.swv.IntentHelper.createIntentForGooglePlay;
import static store.firebook.swv.PreferenceHelper.setAgreeShowDialog;
import static store.firebook.swv.PreferenceHelper.setRemindInterval;
import static store.firebook.swv.UriHelper.getAmazonAppstore;
import static store.firebook.swv.UriHelper.getGooglePlay;
import static store.firebook.swv.UriHelper.isPackageExists;
import static store.firebook.swv.Utils.getDialogBuilder;
