...
import static store.firebook.swv.DialogManager.create;
import static store.firebook.swv.PreferenceHelper.getInstallDate;
import static store.firebook.swv.PreferenceHelper.getIsAgreeShowDialog;
import static store.firebook.swv.PreferenceHelper.getLaunchTimes;
import static store.firebook.swv.PreferenceHelper.getRemindInterval;
import static store.firebook.swv.PreferenceHelper.isFirstLaunch;
import static store.firebook.swv.PreferenceHelper.setInstallDate;
