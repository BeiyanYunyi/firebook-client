...
class SmartWebView {
	...
	// URL configs
	static String ASWV_URL_ONLINE	  = "https://firebook.store";	// if online URL is not provided, offline URL will be loaded by default
	...
	static String ASWV_EXC_LIST       = "firebook.store";       //separate domains with a comma (,)
	...
	static String USER_AGENT_POSTFIX        = "FirebookClient"; // useful for identifying traffic, e.g. in Google Analytics
