...
<a href="https://github.com/store/Android-SmartWebView/"><img src="https://raw.githubusercontent.com/store/Android-SmartWebView/master/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png" width="100"></a>
...
1. Download repo or clone the project
    ...
    `git clone https://github.com/store/Android-SmartWebView`
...
```kotlin
ASWV_URL   = "https://github.com/store"   // domain or directory or address to any root file
```
